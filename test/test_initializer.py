...
from pyrat_engine.initializer.initializer import Initializer
...
def test_generate_random_cheese_list():
    ...
    assert(Initializer.generate_simple_random_cheese_state(maze_config=MazeConfig()).cheeses == expectedList)
